...
public class CPHInline
{
    ...
    public bool Execute()
    {
        ...
        CPH.SetUserVar(userId, "boinacoin_multiplier", subMultiplier, true);
        ...
        int resubStreak = CPH.GetUserVar<int>(userId, "boinacoin_streak_sub", true);
        resubStreak++;
        CPH.SetUserVar(userId, "boinacoin_streak_sub", resubStreak, true);
