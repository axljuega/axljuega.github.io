...
public class CPHInline
{
    ...
    public bool Execute()
    {
        ...
        int lastAnnounced = CPH.GetUserVar<int>(userId, "boinacoin_rank_announced", true);
        ...
        CPH.SetUserVar(userId, "boinacoin_rank_announced", newRank, true);
        ...
        if (bonus > 0)
        {
            long balance = CPH.GetUserVar<long>(userId, "boinacoin", true) + bonus;
            CPH.SetUserVar(userId, "boinacoin", balance, true);

            long totalEarned = CPH.GetUserVar<long>(userId, "boinacoin_total_earned", true) + bonus;
